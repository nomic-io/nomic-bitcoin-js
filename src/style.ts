...
export const BTC = {
  ...
  qrOptions: { typeNumber: '0', mode: 'Byte', errorCorrectionLevel: 'Q' },
  imageOptions: { hideBackgroundDots: true, imageSize: 0.2, margin: 4 },
  dotsOptions: { type: 'dots', color: '#ff9900', gradient: null },
  backgroundOptions: {
    color: 'white',
    gradient: null,
  },
  ...
  cornersSquareOptions: { type: 'dot', color: '#ff9900', gradient: null },
  cornersSquareOptionsHelper: {
    colorType: { single: true, gradient: false },
    gradient: {
      linear: true,
  ...
  cornersDotOptions: { type: 'dot', color: '#ff9900', gradient: null },
  cornersDotOptionsHelper: {
    colorType: { single: true, gradient: false },
    gradient: {
      linear: true,
